...
Uses Claude Code SDK to generate professional copywriting with multiple versions.
"""
...
app = FastAPI(
    ...
    description="Backend API for copywriting interface with multiple variations using Claude Code SDK",
    version="1.0.0",
)
...
async def generate_copy_variations(
    ...
    """
    Generate copy variations from Claude Code SDK.
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Claude Code SDK error: {str(e)}")
