...
An interactive calculator agent with custom tools for mathematical calculations and unit conversions. This agent demonstrates advanced Claude Code SDK features including custom tool creation, MCP server configuration, and REPL functionality.
...
- `claude-code-sdk`: Claude Code Python SDK
