...
A specialized agent system for orchestrating engineering work through a micro Software Development Life Cycle (SDLC) workflow. This application provides a kanban board interface for managing tickets that progress through automated planning, building, and review stages powered by Claude Code SDK agents.
...
### Agent Issues
- Check Claude Code SDK is properly configured
