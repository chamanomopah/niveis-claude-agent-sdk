...
Monitor Bluesky social media firehose in real-time, filter posts by keywords, and use Claude Code SDK to summarize and analyze sentiment of matching content.

## Capabilities

- **Real-time WebSocket monitoring** of Bluesky firehose
- **Keyword-based content filtering** with configurable search terms
- **Claude Code SDK integration** for intelligent content analysis
...
- Claude Code SDK for content summarization
...
- `claude-code-sdk`: AI-powered content analysis
...
- **Claude Code SDK query()** for AI-powered analysis
