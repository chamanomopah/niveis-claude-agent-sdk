...
A specialized REPL agent for answering questions about codebases using parallel search capabilities and the Claude Code SDK.
...
- **`pyproject.toml`**: Specifies dependencies (claude-code-sdk, rich)
