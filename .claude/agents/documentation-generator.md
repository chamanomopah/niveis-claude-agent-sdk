...
description: PROACTIVELY use after implementation is complete to generate feature documentation. Creates concise documentation from implementation changes. Specialized for doc generation and conditional docs updates.
