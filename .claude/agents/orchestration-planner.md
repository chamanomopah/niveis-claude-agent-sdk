...
description: PROACTIVELY use when designing complex multi-agent workflows requiring phase coordination. Plans multi-agent orchestration workflows with phase design and agent coordination.
