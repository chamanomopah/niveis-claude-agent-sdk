---
name: test-resolver
description: PROACTIVELY use when tests fail. Analyzes failed tests, identifies root causes, applies fixes, and re-validates. Specialized for test failure resolution.
