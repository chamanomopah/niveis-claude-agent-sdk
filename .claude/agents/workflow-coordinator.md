...
description: PROACTIVELY use when coordinating multi-phase workflows. Manages phase transitions and result aggregation across agents. Specialized for orchestration of complex multi-agent workflows.
