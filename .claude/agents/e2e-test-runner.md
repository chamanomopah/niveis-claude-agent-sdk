...
description: PROACTIVELY use when running end-to-end tests. Executes E2E test specifications with browser automation, captures screenshots, and reports structured results.
tools: Bash, Read
model: opus
color: cyan
---
