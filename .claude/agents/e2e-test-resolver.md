...
description: PROACTIVELY use when E2E tests fail. Analyzes failed E2E tests using screenshots and error context, applies fixes, and re-validates user journeys.
