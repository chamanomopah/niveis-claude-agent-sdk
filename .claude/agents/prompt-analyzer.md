...
description: PROACTIVELY use when evaluating prompt files for improvement opportunities. Analyzes and classifies existing prompts by sophistication level, structural sections, and quality indicators.
