...
description: PROACTIVELY use when executing generated plans that require code changes. Follows plans precisely, makes code changes, runs validation commands. Specialized for implementation phase.
