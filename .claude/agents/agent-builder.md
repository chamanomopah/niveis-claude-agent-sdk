---
name: agent-builder
description: PROACTIVELY use when designing agent files, system prompts, or configurations. Builds custom agent configurations for domain-specific problems using Claude Agent SDK patterns.
