...
description: PROACTIVELY use when setting up parallel agent environments. Creates isolated Git worktree environments for parallel agent execution. Specialized for environment configuration and isolation.
