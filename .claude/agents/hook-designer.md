---
name: hook-designer
description: PROACTIVELY use when designing permission hooks for agent governance and security controls. Specialized for creating hook implementations that control agent permissions and provide audit trails.
