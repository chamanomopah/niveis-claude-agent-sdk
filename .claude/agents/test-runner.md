---
name: test-runner
description: PROACTIVELY use when executing unit/integration tests and reporting results in structured JSON format. Specialized for test execution with comprehensive reporting.
tools: Bash, Read
model: opus
color: cyan
---
