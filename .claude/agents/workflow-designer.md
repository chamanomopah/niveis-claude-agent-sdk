...
description: PROACTIVELY use when creating numbered steps, conditionals, loops, and delegation patterns for prompt workflows. Designs well-structured workflow sections for agentic prompts with appropriate control flow patterns.
